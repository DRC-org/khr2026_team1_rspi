...
def create_map_from_svg(svg_path, output_base):
    ...
    for rect in root.iter('{http://www.w3.org/2000/svg}rect'):
        ...
        if brown_color in style or brown_color in fill:
            label = rect.get('{http://www.inkscape.org/namespaces/inkscape}label', 'unknown')
...
if __name__ == "__main__":
    # Path to SVG file
    svg_file = "/home/host1/repos/khr2026_team1_bt_controller/src/assets/khr2026_field.svg"
